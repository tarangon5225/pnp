...
def jugar():
    ...
    print("AYUDAS:")
    print("- BEEPER: Si Reeborg se detiene sobre un Beeper, automáticamente este será impulsado una fila.")
    print("- ESTRELLA: Si Reeborg se detiene sobre una estrella, avanza de nuevo la cantidad de casillas que obtuvo en el dado.")
    print("TRAMPAS:")
    print("- TULIPAN: Si Reeborg se detiene sobre un tulipán, da un giro de 180° y se regresará las casillas avanzadas.")
